...
const AdminLoginRoute = AdminLoginImport.update({ path: '/login', getParentRoute: () => AdminRoute } as any)
...
export interface FileRoutesByPath {
  ...
  '/admin/login': { id: '/admin/login'; path: '/login'; fullPath: '/admin/login'; preLoaderRoute: typeof AdminLoginImport; parentRoute: typeof AdminRoute; }
